export class DonateList {
  ...
  render() {
    ...
    const donatesContainerTitle = this.#createElement('h2', 'donates-container__title');
    donatesContainerTitle.textContent = "Список донатов";

    const donatesContainerDonates = this.#createElement("div", "donates-container__donates");
